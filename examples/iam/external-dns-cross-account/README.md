...
> **Folder:** `examples/iam/external-dns-cross-account/` · **Lab Type:** floci runnable · **Scope:** Platform, cross-account
...
Lab này tạo hosted zone thật trên floci Route53, bootstrap TXT record, source roles ở app account, và target writer roles ở shared-services account.
