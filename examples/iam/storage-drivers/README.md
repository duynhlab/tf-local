...
> **Folder:** `examples/iam/storage-drivers/` · **Lab Type:** floci runnable · **Scope:** Platform storage
...
Lab này tạo **EBS volume + snapshot** để có tài nguyên storage thật trên floci, cùng IAM roles cho EBS CSI và EFS CSI. Phần EFS ở mức IAM shape vì support matrix của repo chỉ khẳng định EBS.
