...
> **Folder:** `examples/iam/s3-go-compute-matrix/` · **Resources:** ~30 · **Accounts:** 888888888888 (App), 999999999998 (Data) · **Regions:** ap-southeast-1 + us-east-1
...
- IAM rules được **lưu chứ không enforce** (xem `examples/examples/iam/README.md` §floci compatibility).
