...
#trivy:ignore:AVD-AWS-0095 floci KMS CreateKey fails on aliased providers; using AWS-managed key
...
module "team_b_queues" {
  source = "../../../modules/messaging/sqs-with-dlq"
...
module "sqs_consumer_irsa" {
  source = "../../../modules/_legacy/irsa-role"
